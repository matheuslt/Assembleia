...
public class UsuarioService {
	...
	public void verificarSeVotou(Usuario usuario) throws UsuarioServiceException {
		if (ur.verificarSeVotou(usuario.getId()) != null) {
			throw new UsuarioServiceException("O usuario já votou.");
		}
	}
}
